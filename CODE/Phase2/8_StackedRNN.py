...
print("")
print('-------------------- Training --------------------')
rnn_model = model.fit(X_train, y_train, epochs=epochs, batch_size=batch_size, validation_data=(X_val, y_val))
print("")
...
print('Test set RNN Model\n  Loss: {:0.3f}\n  Accuracy: {:0.3f}'.format(rnn_eval[0], rnn_eval[1]))
print("")
...
model.save('/data3/nlp/akanksha_19022/akanksha_19022/MODEL/RNN')

################# Step 6 - Use model to make predictions
print("")
print('-------------------- Predicting for test dataset--------------------')
model = models.load_model('/data3/nlp/akanksha_19022/akanksha_19022/MODEL/RNN')
...
np.savetxt("testdata_classlabels_RNN.csv", results, delimiter = ',', fmt="%s")